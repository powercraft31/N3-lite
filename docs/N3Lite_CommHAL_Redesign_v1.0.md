# N3Lite Communication Platform HAL Redesign v1.0
...
typedef struct ICommPlatform {
     ...
     * @note The implementation MUST NOT block for more than 10ms.
     */
    void (*send_start_cmd)(ChargingStation *station);
     ...
     * @note The implementation MUST NOT block for more than 10ms.
     */
    void (*send_suspend_cmd)(ChargingStation *station);
...
static void default_send_limit_current_cmd(ChargingStation *station)
{
    PublishEvent(EVENT_AUTO_SET_LIMIT_CUUR,
                 (char *)station, sizeof(ChargingStation));
}

static void default_send_start_cmd(ChargingStation *station)
{
    PublishEvent(EVENT_AUTO_START,
                 (char *)station, sizeof(ChargingStation));
}

static void default_send_suspend_cmd(ChargingStation *station)
{
